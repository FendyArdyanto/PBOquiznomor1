    ...
    public static void main(String[] args) {
        ...
        if (!id.equalsIgnoreCase("admin123") ) {
            ...
            if(pilih == 1){ 
                ...
                barang_masuk brg_msk = new barang_masuk();
                barang_keluar brg_klr = new barang_keluar();
                brg_msk.listBarang();
                ...
                if(pilih == 0){
                    ...
                    if (pilih == 1){
                        ...
                        System.out.println("");
                        System.out.println("");
                        System.out.println("Sisa Kas dari Total Pengeluaran = Rp. "+(brg_msk.total_kas+brg_msk.total_pemasukan-subTotal));
                        System.out.println("");
                        System.out.println("");
                        System.out.println("Administrasi Persediaan Barang Distributor PT. Garuda Abadi Group");
                        System.out.println("Check, Data dan Antar, Ketelitian Anda dalam Administrasi di Utamakan (*_*)");
                    ...
                    if (pilih == 1){
                        ...
                        System.out.println("");
                        System.out.println("");
                        System.out.println("  Sisa Kas dari Total Pengeluaran = Rp. "+(brg_klr.total_sisaKas+brg_msk.total_pemasukan-subTotal));
                        System.out.println("");
                        System.out.println("");
                        System.out.println("Administrasi Persediaan Barang Distributor PT. Garuda Abadi Group");
                        System.out.println("Check, Data dan Antar, Ketelitian Anda dalam Administrasi di Utamakan (*_*)");
